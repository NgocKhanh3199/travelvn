...
<body>
        ...
        <div class="container-fluid navbar-menu">
            ...
            <div class="navbar-brand d-flex menu-bar" href="#">
                <ul class="d-flex me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?page=quanlytour">Quản Lý Tour</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?page=quanlydonhang">Đơn Hàng</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link">Giao Dịch</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 text-dark">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Giao Dịch</a>
                        </li>
                    </ul>
    ...
    <?php
    require_once "./view/trangchu/fooder.php";
    ?>
