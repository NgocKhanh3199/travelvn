            ...
            <div class="register-content">
                <div class="register-by-account">
                    <div class="register-input mt-4">
                        ...
                        <input required type="text" class="form-control" id="namecompany" placeholder="Nhập tên công ty">
                    </div>
                    <div class="register-input mt-4">
                    ...
                    <div class="register-input mt-4">
                        ...
                        <input required type="text" class="form-control" id="ward" placeholder="Nhập xã/phường/thị trấn">
                    </div>
                    <div class="register-input mt-4">
                ...
                <div class="register-by-account">
                    <div class="register-input mt-4">
                        ...
                        <input required type="text" class="form-control" id="phone" placeholder="Nhập số điện thoại">
                    </div>
                    <div class="register-input mt-4">
                        <label for="address" class="form-label">Địa Chỉ</label>
                        <input required type="text" class="form-control" id="address" placeholder="Nhập địa chỉ">
                    </div>

                    <div class="register-input mt-4">
                        <label for="district" class="form-label">Quận</label>
                        <input required type="text" class="form-control" id="district" placeholder="Nhập quận">
                    </div>
                    <div class="register-input mt-4">
                        <label for="street" class="form-label">Số Đường</label>
                        <input required type="text" class="form-control" id="street" placeholder="Nhập số đường">
                    </div>
                    <div class="register-input mt-4">
